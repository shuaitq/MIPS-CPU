...
`define WriteEnable         1'b1            // 使能读
`define WriteDisable        1'b0            // 禁止读
`define ReadEnable          1'b1            // 使能写
`define ReadDisable         1'b0            // 禁止写
`define AluOpBus            7:0             // 译码阶段的输出aluop_o的宽度
`define AluSelBus           2:0             // 译码阶段的输出alusel_o的宽度
`define InstValid           1'b0            // 指令有效
`define InstInvalid         1'b1            // 指令无效
`define Stop                1'b1            // 流水线停止
`define NoStop              1'b0            // 流水线继续
`define InDelaySlot         1'b1            // 处在延迟槽
`define NotInDelaySlot      1'b0            // 没有处在延迟槽
`define Branch              1'b1            // 在分支上
`define NotBranch           1'b0            // 没有分支
...
`define InstMemNum      64              // ROM的实际大小为
`define InstMemNumLog2  6               // ROM实际使用的地址线的宽度
